										...
										Elem: &schema.Resource{
											Schema: map[string]*schema.Schema{
												...
												"trigger_type": {
													Type:         schema.TypeString,
													Required:     true,
													ValidateFunc: validation.StringInSlice([]string{"TIME_TRIGGER", "METRICS_TRIGGER"}, false),
												},
												"activity_type": {
													Type:         schema.TypeString,
													Required:     true,
												...
												"adjustment_type": {
													Type:         schema.TypeString,
													Optional:     true,
													ValidateFunc: validation.StringInSlice([]string{"CHANGE_IN_CAPACITY", "EXACT_CAPACITY"}, false),
												},
												"adjustment_value": {
													Type:         schema.TypeInt,
													Required:     true,
													...
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															...
															"recurrence_type": {
																Type:         schema.TypeString,
																Optional:     true,
																ValidateFunc: validation.StringInSlice([]string{"MINUTELY", "HOURLY", "DAILY", "WEEKLY", "MONTHLY"}, false),
															},
															"recurrence_value": {
																Type:     schema.TypeString,
																Optional: true,
													...
													Elem: &schema.Resource{
														Schema: map[string]*schema.Schema{
															...
															"cool_down_interval": {
																Type:         schema.TypeInt,
																Optional:     true,
																ValidateFunc: validation.IntBetween(0, 10800),
															},
																...
																Elem: &schema.Resource{
																	Schema: map[string]*schema.Schema{
																		...
																		"statistics": {
																			Type:         schema.TypeString,
																			Required:     true,
																			ValidateFunc: validation.StringInSlice([]string{"MAX", "MIN", "AVG"}, false),
																		},
																		"comparison_operator": {
																			Type:         schema.TypeString,
																			Required:     true,
																			ValidateFunc: validation.StringInSlice([]string{"EQ", "NE", "GT", "LT", "GE", "LE"}, false),
																		},
																		"threshold": {
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"priority": {
							Type:       schema.TypeInt,
							Optional:   true,
							Deprecated: "Field 'priority' has been deprecated from provider version 1.226.0.",
						},
						"execution_moment": {
							Type:         schema.TypeString,
							Required:     true,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									...
									"node_group_id": {
										Type:       schema.TypeString,
										Optional:   true,
										Deprecated: "Field 'node_group_id' has been deprecated from provider version 1.226.0. New field 'node_group_ids' replaces it.",
									},
									"node_group_ids": {
										Type:     schema.TypeList,
										Optional: true,
									...
									"node_group_name": {
										Type:       schema.TypeString,
										Optional:   true,
										Deprecated: "Field 'node_group_name' has been deprecated from provider version 1.226.0. New field 'node_group_names' replaces it.",
									},
									"node_group_names": {
										Type:     schema.TypeList,
										Optional: true,
...
func resourceAlicloudEmrV2ClusterUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("node_groups") {
		...
		for _, nodeGroupItem := range oldNodeGroupsList.(*schema.Set).List() {
