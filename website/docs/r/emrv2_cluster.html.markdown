...
* `auto_scaling_policy` - (Optional, Available since v1.224.0) The node group auto scaling policy for emr cluster. See [`auto_scaling_policy`](#node_groups-auto_scaling_policy) below.
...
* `priority` - (Deprecated from 1.226.0) The bootstrap scripts priority.
...
* `node_group_id` - (Deprecated from 1.226.0) The bootstrap scripts execution target node group id.
* `node_group_ids` - (Optional) The bootstrap scripts execution target node group ids.
* `node_group_types` - (Optional) The bootstrap scripts execution target node group types.
* `node_group_name` - (Deprecated from 1.226.0) The bootstrap scripts execution target node group name.
* `node_group_names` - (Optional) The bootstrap scripts execution target node group names.
